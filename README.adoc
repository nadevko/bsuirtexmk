...
ENSTD is simply inhumane. There are a lot of letters, it's hard to remember,
it's hard to read. For a mere mortal student -- an impossible task. Not everyone
has an obedient ksisarian, right? :3
...
BSUIR:: link:./doc/standard/bsuir/2017/simple.adoc[2017]
